...
GoDoc at https://godoc.org/github.com/donetkit/shadowsocks/

![Build and test](https://github.com/donetkit/shadowsocks/workflows/Build%20and%20test/badge.svg)
...
Pre-built binaries for common platforms are available at https://github.com/donetkit/shadowsocks/releases

Install from source

```sh
go get -u -v github.com/donetkit/shadowsocks
```
